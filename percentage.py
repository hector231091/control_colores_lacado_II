...
class ShowPercentage(Frame):
    def __init__(self, parent): 
        ...
        self.efficiency_colour_title = Label(self, text="Rendimiento del último color", anchor="center", relief="groove")
        self.efficiency_colour_title.grid(row=0,
                                          ...
                                          ipady=CELL_MARGIN, 
                                          sticky=W + E + N + S)
        self.efficiency_colour_result = Label(self, textvariable=self.show_efficiency_hangers, bg="white", anchor="center", relief="groove")
        self.efficiency_colour_result.grid(row=1,
                                           ...
                                           ipady=CELL_MARGIN, 
                                           sticky=W + E + N + S)
        self.efficiency_change_colour_title = Label(self, text="Rendimiento del último cambio de color", anchor="center", relief="groove")
        self.efficiency_change_colour_title.grid(row=3,
                                                 ...
                                                 ipady=CELL_MARGIN, 
                                                 sticky=W + E + N + S)
        self.efficiency_change_colour_result = Label(self, textvariable=self.show_efficiency_change_colour, bg="white", anchor="center", relief="groove")
        ...
        def __get_change_colour_time_efficiency(self, color_1_and_2, change_times_list):
            ...
            try:
                ...
                self.show_efficiency_change_colour.set(self.calculate_efficiency_change_colour(self.index_concatenate_colours))

            except ValueError:
                self.show_efficiency_change_colour.set("No hay datos\nanteriores con lo\nque comparar.")

        def __get_colour_time_efficiency(self, start_datetime_as_string, end_datetime_as_string, amount_of_hangers_as_string):
